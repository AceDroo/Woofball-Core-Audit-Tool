...
Widget text(String text) {
  return Container(
      width: 350,
      child: Text(text, style: TextStyle(fontSize: 16), textAlign: TextAlign.left)
  );
}
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        ExpansionTile(
                          ...
                          title: Text(
                              "Summary Report", style: TextStyle(fontSize: 16)),
                          children: <Widget>[
                            text("Problems: "),
                        ...
                        ExpansionTile(
                            ...
                            children: <Widget>[
                              ExpansionTile(
                                ...
                                children: <Widget>[
                                  textLink(
                                      "1.1. Type of Intersection: T-Intersection",
                                      context),
                                  textLink(
                                      "1.2. Traffic Control: Traffic light",
                                      context),
                                  textLink(
                                      "1.3. Type of Intersection Crosswalk: Zebra striping",
                                      context),
                                  textLink(
                                      "1.4. Crossing Aids at Intersection: None",
                                      context),
                                  textLink(
                                      "1.5. Take or upload photo: No photo uploaded\n",
                                      context),
                                  Align(alignment: Alignment.topLeft, child:
                                  Padding(padding: EdgeInsets.only(
                                      left: 20, bottom: 10), child:
                                  FlatButton(
                                    color: Theme
                                        .of(context)
                                        .accentColor,
                                    textColor: Theme
                                        ...
                                        .color,
                                    child: new Text(
                                        "Edit", style: TextStyle(fontSize: 16)),
                                    onPressed: () {
                                      Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                            builder: (context) =>
                                                Survey(page: 0,
                                                  editMode: true,)), // Go to survey page
                                      );
                                    },
                                  ),
                                  ),
                              ...
                              ExpansionTile(
                                ...
                                children: <Widget>[
                                  textLink("2.1. Overall cleanliness: 2 (Poor)",
                                      context),
                                  textLink(
                                      "2.2. Features that provide shade: None",
                                      context),
                                  textLink(
                              ...
                              ExpansionTile(
                                  ...
                                  children: <Widget>[
                                    ...
                                    textLink(
                                        ...
                                        context),
                                    textLink(
                                        "6.3. Number of land uses present on the segment:",
                                        context),
                                    text(" - Bars/Clubs: 1"),
                                    text(" - Adult Uses: 0"),
                                    text(
                                        " - Check cashing/Pawn Shop/Bail Bonds: 1"),
                                    textLink(
                                        "6.4. Number of gathering places: ",
                                        context),
                                    text(" - Restaurants: 2"),
                                    text(" - Coffee Shops: 1"),
